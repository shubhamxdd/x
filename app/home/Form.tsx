...
const Form = ({ placeholder, isComment, postId, user }: FormProps) => {
      ...
      {user ? (
        <div className="flex flex-row gap-4 ">
          ...
          <div className="w-full">
            ...
            ></textarea>
            <hr className="opacity-0 peer-focus:opacity-100 h-[1px] w-full border-neutral-800 transition-all duration-200" />
        ...
        <div className="py-8">
          ...
          <div className="flex flex-row items-center justify-center gap-4">
            ...
            <Button label="Register" onClick={registerModal.open} secondary />
          </div>
        </div>
      )}
    </div>
